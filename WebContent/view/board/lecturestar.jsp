...
<h2 class="w3-opacity"><select name="lecture">
  	<c:forEach var="article" items="${li1 }" varStatus="i">
  	<option value = "subject_name">${article.subject_name }</option>
  	</c:forEach>
  	</select></h2>
</div>
<div>
...
<img alt="#" src="${pageContext.request.contextPath}/star${grade}.png" style="width: 100px;">
</td>
</div>
<div align="left" style="margin-left: 100px; margin-top: 80px;">
<form class="star-input" method="post" action="${pageContext.request.contextPath}/list/lwritelreplypro">
<input type="hidden" name = "memberid" value="${param.memberid}">
<input type="hidden" name = "boardid" value="${param.boardid}">
	<span class="input">
    	<input type="radio" name="star-input" value="1" id="p1">
    	<label for="p1">너무 별로</label>
    	<input type="radio" name="star-input" value="2" id="p2">
    	<label for="p2">조금 별로에요</label>
    	<input type="radio" name="star-input" value="3" id="p3">
    	<label for="p3">그냥 그래요</label>
    	<input type="radio" name="star-input" value="4" id="p4">
    	<label for="p4">괜찮아요</label>
    	<input type="radio" name="star-input" value="5" id="p5">
    	<label for="p5">완전좋아요</label>
  	</span>
